...
<head>
  ...
  ga('send', 'pageview');
    ...
    <![endif]-->
    <title>Linking & Media Policy</title>
</head>
...
<body id ="MainBody">
        ...
        <DIV id ="HeadMargin">
            <DIV id ="MainHeadAbsolute" class ="navhigh">
                <DIV id ="LogoCustom">
                    ...
                    <DIV id ="PageNameHead">Media Policy</DIV>
                </DIV>
    ...
    <DIV id ="MainContentContain"  class ="MainContentContainClass" >
        ...
        <DIV id ="MainContent">
            ...
            <H1 id ="PageHead">Media Policy</H1>
            
            <BR><BR>If you have discover any image or video that infringes on Copyright Laws, please <a href ="ContactUs.php">Contact Us</a> and we will be more than happy to take the media down upon review.
